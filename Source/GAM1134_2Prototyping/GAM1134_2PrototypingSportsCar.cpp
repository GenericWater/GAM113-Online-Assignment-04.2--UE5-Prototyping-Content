...
#include "GAM1134_2PrototypingSportsCar.h"
#include "GAM1134_2PrototypingSportsWheelFront.h"
#include "GAM1134_2PrototypingSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AGAM1134_2PrototypingSportsCar::AGAM1134_2PrototypingSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGAM1134_2PrototypingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGAM1134_2PrototypingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGAM1134_2PrototypingSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGAM1134_2PrototypingSportsWheelRear::StaticClass();
